...
class OrderDetailsSelfwichAdapter(val clickListener: OrderDetailsSelfwichClickListener)
    :ListAdapter<Selfwich,OrderDetailsSelfwichAdapter.OrderDetailsSelfwichViewHolder>(OrderDetailsSelfwichDiffCallbacks()) {
        ...
        :RecyclerView.ViewHolder(itemBinding.root){
            ...
            companion object{
                fun from(parent: ViewGroup):OrderDetailsSelfwichViewHolder{
                    ...
                    val binding = OrderDetailsSelfwichListItemBinding.inflate(layoutInflater,parent,false)
