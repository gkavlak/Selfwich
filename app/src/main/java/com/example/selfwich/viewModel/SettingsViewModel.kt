...
import com.example.dicode.ui.settings.SettingsForm
import com.example.dicode.ui.settings.SettingsFormState
...
class SettingsViewModel(app: Application, private val settingRepository: SettingsRepository) :
    ViewModel() {
    ...
    open class Factory(val app: Application, private val settingRepository: SettingsRepository) :
